...
* API (mycalendar api)
* Обработчик фоновых задач (mycalendar scheduler)
* Отправщик уведомлений (mycalendar sender)

#

## Шестая часть из ТЗ на сервис "Календарь" 
### Докеризация сервиса
Подготовить Docker файлы для каждого из сервисов.
...
## Седьмая часть из ТЗ на сервис "Календарь" 
